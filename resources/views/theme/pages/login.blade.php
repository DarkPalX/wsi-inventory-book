...
@section('content')
    ...
    <div id="cover-banner">
        ...
        <h1 class="text-uppercase text-light" style="font-size: 70px;">Webfocus Solutions Incorporated</h1>
        ...
        <div class="section bg-transparent min-vh-100 p-0 m-0">
            <div class="vertical-middle">
                <div class="container-fluid py-5 mx-auto">
                    ...
                    <div class="text-center dark mt-3"><small class="bg-dark p-1 rounded rounded-3">Copyrights &copy; All Rights Reserved by Webfocus Solutions Inc.</small></div>
