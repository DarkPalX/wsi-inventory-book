    ...
    <div class="wrapper p-5">
        ...
        <div class="row mt-4 mb-3">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-end">
                ...
                <a href="{{ route('receiving.transactions.create') }}" class="btn btn-primary">Create Transaction</a>
            </div>
                    ...
                    <tbody>
                        @forelse ($transactions as $transaction)
                            <tr id="row{{$transaction->id}}" @if($transaction->trashed()) class="table-danger" @endif>
                                ...
                                <td>
                                    <small>
                                        <strong>{{ User::getName($transaction->cancelled_by) }}</strong><br>
                                ...
                                <td>
                                    <div style="position: relative; display: inline-block;">
                                        <p id="remarks-text-{{ $transaction->id }}" class="remarks-text" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; width:500px; word-break: break-word; text-overflow: ellipsis;">
                                ...
                                {{-- <td>
                                    <div id="remarks-container-{{ $transaction->id }}" style="position: relative; display: inline-block; width: 500px;">
                                        <p id="remarks-text-{{ $transaction->id }}" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-break: break-word; text-overflow: ellipsis;">
                                            {{ $transaction->remarks }}
                                        </p>
                                        <small id="read-more-{{ $transaction->id }}" style="cursor: pointer; display: none;" onclick="toggleText({{ $transaction->id }})"> See More ..</small>
                                    </div>
                                </td> --}}
                                <td>
                                    ...
                                    {{-- <a href="{{ route('receiving.transactions.show', $transaction->id) }}" class="btn btn-light text-primary" title="View Transaction"><i class="bi-eye"></i></a> --}}
