                            ...
                            <div class="table-responsive-faker">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @php($receiving_total_cost = 0)

                                        @foreach($receiving_details as $receiving_detail)

                                            @php($receiving_total_quantity += $receiving_detail->quantity)
                                            @php($receiving_total_cost += $receiving_detail->book->total_cost ?? 0)

                                            <tr>
                                                <td>{{ $receiving_detail->book_id }}</td>
                                                <td>{{ $receiving_detail->sku }}</td>
                                                <td>{{ $receiving_detail->book->name }}</td>
                                                <td class="text-end">{{ $receiving_detail->quantity }}</td>
                                                <td class="text-end">{{ number_format($receiving_detail->book->total_cost ?? 0, 2) }}</td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td class="text-end" colspan="100%"><hr></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-end text-primary"><strong>{{ number_format($receiving_total_cost, 2) }}</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
